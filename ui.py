...
col1.title("🔒 BitLocks SETUP ASSISTANT 🔒")
...
# Introduction
st.markdown(
    "Welcome to the BitLocks Setup Assistant! This app helps you generate setup scripts for managing "
    "BitLocks installations.")

# Create BitLocks object
bitlocks_setup = bitlocks.BitLocksSetup()
